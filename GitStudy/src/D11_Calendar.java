...
public class D11_Calendar {
	...
	public static void main(String[] args) {
		...
		// ※ 유닉스타임 - 1970년 1월 1일 이후로 시간이 몇 밀리초나 흘렀는지 센 것
			...
			/*		# Date
			 * 		- Date 클래스 내부의 메서드들은 요즘 버전에서는 거의 업데이트가 중단됨
			 * 		- 시간을 계산할 때는 다른 클래스를 사용할 것을 권장한다
			 * 		- Date 클래스는 주로 시간 인스턴스를 보관하는 용도로만 사용한다
			 */
			
			Date now = new Date();
			System.out.println(now); // toString이 구현되어 있음
			...
			// Calendar.ERA가 필드 상수이고, Calendar.AM과 Calendar.AD와 .BC가 상수이다
			...
			System.out.println("센트럴 현재 시간 : " + new_york.get(Calendar.HOUR));
